...
let sundefinedVariable = undefined;
let frutas = [string,num,boolean];

console.log(string,num,boolean,null,sundefinedVariable,frutas)
...
let result2 =(typeof(num3) != typeof(num3AsString)) //Realiza la operación de comparación que consideres con las dos variables del ejercicio anterior para que el resultado en consola sea true.
console.log(result2)
